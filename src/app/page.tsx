...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'jobsearch.quest — Job Search Support You\'ll Actually Use',
    description: 'The Never Search Alone methodology with AI advisors. No recruiting, no scheduling. Start your first session free.',
    type: 'website',
  ...
  const faqJsonLd = {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: { '@type': 'Answer', text: 'It\'s a complement, not a replacement. A real JSC with human peers is powerful in ways AI can\'t replicate — shared experience, serendipitous connections, genuine social accountability. jobsearch.quest gives you structured support and the NSA methodology, available right now, while you look for peers to form a real council.' },
      },
      {
        '@type': 'Question',
        name: 'How does an AI Job Search Council work?',
        acceptedAnswer: { '@type': 'Answer', text: 'jobsearch.quest follows the Never Search Alone 10-session curriculum. Each session has structured phases: check-in, exercise, hot seat (where AI advisors challenge your thinking from multiple perspectives), commitments, and check-out. The AI remembers your context across sessions, tracks your commitments, and guides you from defining what you want through evaluating offers.' },
      },
      {
        '@type': 'Question',
      ...
      },
      {
        ...
        acceptedAnswer: { '@type': 'Answer', text: 'Yes. The app supports "Slow Seeker" and "Exploring Quietly" modes. Your advisors adapt with less urgency and more strategic framing. Many users run monthly sessions to stay intentional about their career, especially for career pivots or finding Candidate-Market Fit.' },
      },
    ],
  };
    ...
    <>
        ...
        <div className={styles.container}>
          ...
          <div className={styles['problem-grid']}>
            ...
            <div className={styles['problem-card']}>
              ...
              <p>Solo seekers spend weeks &ldquo;researching&rdquo; instead of acting. Structured support forces <a href="/learn/job-search-accountability" style={{ color: 'inherit', textDecoration: 'underline' }}>specific commitments</a> every week.</p>
            </div>
            <div className={styles['problem-card']}>
              <div className={styles.stat}>1 in 3</div>
              <h3>Quit within 6 months</h3>
              <p>Taking the first offer from <a href="/learn/job-search-burnout" style={{ color: 'inherit', textDecoration: 'underline' }}>exhaustion</a> leads to regret. A support team keeps you honest about what you actually want.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className={styles.section} id="compare">
        <div className={styles.container}>
          ...
          <h2 className={styles.display} style={{ fontSize: '24px', fontWeight: 700, letterSpacing: '-0.02em', marginBottom: '4px' }}>One voice vs. a whole team</h2>
          <p style={{ color: 'var(--text-secondary)', fontSize: '14px', marginBottom: '32px' }}>ChatGPT gives you tips. A support team gives you perspectives, structure, and accountability.</p>
          <ComparisonSection />
        </div>
      </section>
      ...
      <section className={styles.section}>
        <div className={styles.container}>
          ...
          <p style={{ fontSize: '16px', lineHeight: 1.75, color: 'var(--text)', marginBottom: '16px' }}>
            <strong>jobsearch.quest</strong> runs the full <a href="/learn/never-search-alone-methodology" style={{ color: 'inherit', textDecoration: 'underline' }}>Never Search Alone</a> 10-session curriculum &mdash; the Mnookin Two-Pager, Listening Tour, Candidate-Market Fit, all of it &mdash; with AI advisors who challenge your thinking, hold you accountable, and push you toward the right role.
          </p>
          <p style={{ fontSize: '16px', lineHeight: 1.75, color: 'var(--text)', marginBottom: '16px' }}>
            A real <a href="/learn/what-is-a-job-search-council" style={{ color: 'inherit', textDecoration: 'underline' }}>Job Search Council</a> with real people is the gold standard. But finding 4&ndash;5 peers who are actively searching, aligning schedules, and getting everyone to show up every week &mdash; most people never get past that step. jobsearch.quest gives you the methodology and structured support you can <a href="/learn/ai-job-search-council-vs-solo-search" style={{ color: 'inherit', textDecoration: 'underline' }}>start tonight</a>.
          </p>
          <div style={{ display: 'flex', gap: '32px', flexWrap: 'wrap', marginTop: '24px' }}>
            ...
            <div style={{ flex: 1, minWidth: '200px' }}>
              <p className={styles.mono} style={{ fontSize: '11px', color: 'var(--text-tertiary)', textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: '8px' }}>The team</p>
              <p style={{ fontSize: '14px', color: 'var(--text-secondary)', lineHeight: 1.7 }}>
                AI advisors with distinct perspectives &mdash; from strategic thinkers to devil&apos;s advocates. They don&apos;t agree with each other.
              </p>
            </div>
            <div style={{ flex: 1, minWidth: '200px' }}>
              ...
              <p style={{ fontSize: '14px', color: 'var(--text-secondary)', lineHeight: 1.7 }}>
                Weekly <a href="/learn/job-search-accountability" style={{ color: 'inherit', textDecoration: 'underline' }}>commitments</a> tracked across sessions. Your team remembers what you said you&apos;d do &mdash; and asks about it.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className={styles.container}>
          <div className={styles['book-layout']}>
            ...
            <div className={styles['book-text']}>
              ...
              <p>
                <strong>jobsearch.quest brings this methodology to AI.</strong> Same structured curriculum. Same accountability loop. Same exercises &mdash; Mnookin Two-Pager, Gratitude House, Listening Tour, Candidate-Market Fit. But available right now, any time, with no scheduling friction &mdash; your support team never cancels.
              </p>
      ...
      <section className={`${styles.section} ${styles['convo-section']}`} id="conversations">
        <div className={styles.container}>
          <div className={styles['section-label']}>Real conversations</div>
          <h2 className={styles.display} style={{ fontSize: '24px', fontWeight: 700, letterSpacing: '-0.02em', marginBottom: '4px' }}>Hear what your sessions sound like</h2>
      ...
      <section className={styles.section} id="how">
        <div className={styles.container}>
          ...
          <h2 className={styles.display} style={{ fontSize: '24px', fontWeight: 700, letterSpacing: '-0.02em', marginBottom: '4px' }}>Start a session in minutes, not weeks</h2>
          ...
          <div className={styles.steps}>
            <div className={styles.step}>
              ...
              <p>Pick your advisors &mdash; each with a distinct perspective on your career. A strategist, an action partner, an assumption checker, an emotional compass. They see your situation differently.</p>
            </div>
            <div className={styles.step}>
            ...
            <div className={styles.step}>
              ...
              <p>Each session includes a Hot Seat where every advisor weighs in on your specific situation. Multiple lenses, one conversation.</p>
            </div>
            <div className={styles.step}>
              <div className={styles['step-num']}>04</div>
              <div className={styles['step-icon']}>&#x1F4CB;</div>
              <h3>Stay accountable</h3>
              <p>End each session with specific commitments. Next session, your team checks in. The structure creates momentum &mdash; not pressure.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className={styles.section} id="council" style={{ background: 'var(--surface)', borderTop: '1px solid var(--border)', borderBottom: '1px solid var(--border)' }}>
        <div className={styles.container}>
          <div className={styles['section-label']}>Your team</div>
          <h2 className={styles.display} style={{ fontSize: '24px', fontWeight: 700, letterSpacing: '-0.02em', marginBottom: '4px' }}>7 advisors. Each sees your situation differently.</h2>
          <p style={{ color: 'var(--text-secondary)', fontSize: '14px', marginBottom: '16px' }}>Not peers, not chatbots. AI advisors built to challenge your thinking from specific angles. Pick 3&ndash;5 for your sessions.</p>

          <div className={styles['roster-scroll']}>
            <div className={styles['roster-card']}><div className={styles.emoji}>&#x1F5FA;&#xFE0F;</div><div className={styles.name}>Eli</div><div className={styles.role}>Career arc advisor</div></div>
            <div className={styles['roster-card']}><div className={styles.emoji}>&#x2699;&#xFE0F;</div><div className={styles.name}>June</div><div className={styles.role}>Action partner</div></div>
            <div className={styles['roster-card']}><div className={styles.emoji}>&#x1F608;</div><div className={styles.name}>Rina</div><div className={styles.role}>Assumption checker</div></div>
            <div className={styles['roster-card']}><div className={styles.emoji}>&#x1F50D;</div><div className={styles.name}>Dex</div><div className={styles.role}>Market mirror</div></div>
            <div className={styles['roster-card']}><div className={styles.emoji}>&#x1FA9E;</div><div className={styles.name}>Sam</div><div className={styles.role}>Emotional compass</div></div>
            <div className={styles['roster-card']}><div className={styles.emoji}>&#x1F578;&#xFE0F;</div><div className={styles.name}>Val</div><div className={styles.role}>Network activator</div></div>
            <div className={styles['roster-card']}><div className={styles.emoji}>&#x1F3AF;</div><div className={styles.name}>Kai</div><div className={styles.role}>Interview coach</div></div>
            <div className={styles['roster-card']}><div className={styles.emoji}>&#x1F4CB;</div><div className={styles.name}>Maude</div><div className={styles.role}>Moderator &middot; every session</div></div>
          </div>
        </div>
      </section>
          ...
          <div style={{ display: 'flex', gap: '40px', alignItems: 'start', flexWrap: 'wrap', maxWidth: '820px', margin: '0 auto' }}>
            <div style={{ flex: 1, minWidth: '300px' }}>
              ...
              <div style={{ fontSize: '15px', color: 'var(--text-secondary)', lineHeight: 1.75 }}>
                ...
                <p style={{ marginBottom: '12px' }}>The problem was obvious: the methodology works because of the group. But forming a real Job Search Council means finding 4-5 peers, aligning schedules, and hoping everyone actually shows up every week. Most people never get past that step.</p>
                <p style={{ marginBottom: '12px' }}>I thought: what if the support was always there? What if you could run through the Mnookin exercises, get feedback on your Candidate-Market Fit, and prep for interviews &mdash; all with AI advisors who each see your situation differently &mdash; at 11pm on a Tuesday when the anxiety hits?</p>
                <p>So I built it.</p>
            ...
            {plans.filter(p => p.plan !== 'founders_circle').map((p) => (
              <div key={p.plan} className={`${styles['pricing-card']} ${p.featured ? styles.featured : ''}`}>
                ...
                <ul className={styles['pricing-features']}>
                  ...
                  <li>{p.max_council_members} advisors</li>
                ...
                <div className={styles['fc-inner']}>
                  <div className={styles['fc-desc']}>
                    ...
                    <p style={{ fontSize: '14px', color: 'var(--text-secondary)', lineHeight: 1.65, margin: '12px 0' }}>
                      The person who built this thing sits on your team. Charles has built companies, hired hundreds of people, and knows exactly what&apos;s on the other side of the hiring table.
                    </p>
                  </div>
      ...
      <section className={styles.section} id="faq">
        <div className={styles.container}>
          ...
          <div className={styles['faq-list']}>
            ...
            <FaqItem question="Who are the advisors?">
              Seven distinct AI advisors, each with a name and a specific lens: Eli (career strategy), June (action steps), Rina (challenging assumptions), Dex (market positioning), Sam (emotional awareness), Kai (interview prep), and Val (hiring insider perspective). Plus Maude, your moderator, who keeps the session moving. You pick 3&ndash;5 for your team.
            </FaqItem>
            ...
            <FaqItem question="Can I use this if I'm not actively searching?">
              Yes. The app supports &ldquo;Slow Seeker&rdquo; and &ldquo;Exploring Quietly&rdquo; modes. Your advisors adapt &mdash; less urgency, more strategic framing. Many users run monthly sessions to stay intentional about their career. Great for <a href="/learn/career-pivot-guide">career pivots</a> or <a href="/learn/candidate-market-fit">finding your Candidate-Market Fit</a>.
            </FaqItem>
            <FaqItem question="How do I start a Job Search Council?">
              The traditional way is to find 4&ndash;5 peers who are also searching and commit to meeting weekly. The <a href="https://neversearchalone.org/jsc">Never Search Alone community</a> helps match people. If you can&apos;t find a group right away, <a href="/learn/ai-job-search-council-vs-solo-search">start with AI-powered support</a> on jobsearch.quest and begin the curriculum immediately while you look for real peers.
            </FaqItem>
            <FaqItem question="How is this different from ChatGPT or other AI career tools?">
              ChatGPT doesn&apos;t remember your last conversation. It doesn&apos;t check whether you followed through on what you said you&apos;d do. It doesn&apos;t have seven advisors who each see your situation differently and build on each other&apos;s perspectives over weeks. jobsearch.quest follows a <a href="/learn/never-search-alone-methodology">structured 10-session curriculum</a>, tracks your commitments across sessions, and keeps a running understanding of your story &mdash; your must-haves, your fears, your progress, and what your team has already told you. <a href="/learn/ai-career-coach-vs-job-search-council">See the full comparison.</a>
            </FaqItem>
      ...
      <section className={`${styles.section} ${styles['cta-banner']}`}>
        <div className={styles.container}>
          <h2 className={styles.display}>Your support team is ready.</h2>
          ...
          <div className={styles['footer-grid']}>
            <div>
              ...
              <p style={{ color: 'var(--text-tertiary)', fontSize: '13px', marginTop: '8px', lineHeight: 1.6 }}>
                Structured job search support based on the Never Search Alone methodology.
              </p>
